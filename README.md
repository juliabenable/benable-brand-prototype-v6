# Benable Brand Portal — Prototype v6

Iteration of [v5](https://github.com/juliabenable/benable-brand-prototype-v5). Forked from v5 (v4 baseline carried forward). v6 is the working baseline for the next round of changes (per Tony's May 19 feedback: end-of-campaign wrap-up, simpler per-creator acknowledgment popup, rights moved into the wrap-up).
